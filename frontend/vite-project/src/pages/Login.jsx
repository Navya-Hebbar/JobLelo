...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const errorMsg = error.message || "Login failed due to a server error.";
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-4 py-10 md:py-12 lg:py-16 overflow-y-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-8 items-start">
          <form
            ...
            className="relative rounded-2xl border border-emerald-400/20 bg-white/5 backdrop-blur-xl shadow-[0_0_30px_rgba(16,185,129,0.25)] p-5 md:p-7 lg:p-8 space-y-5"
          >
            ...
            <button
              ...
              className="w-full inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-black font-bold text-sm md:text-base transition-all shadow-lg shadow-emerald-500/30 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isSubmitting ? (
                <>
          ...
          <div className="relative rounded-2xl border border-gray-700/60 bg-white/5 backdrop-blur-xl p-5 md:p-7 lg:p-8 space-y-5 self-stretch">
            ...
            <div className="border-t border-gray-700/60 pt-3 md:pt-4">
              ...
              <p className="text-xs md:text-sm text-gray-300">
                Never share your password with anyone. JOBLELO uses secure
            ...
            <div className="border-t border-gray-700/60 pt-3 md:pt-4">
              ...
              <p className="text-xs md:text-sm text-gray-300">
                Create an account to access AI-powered career tools, resume
                builder, skill tests, and job matching.
              </p>
            </div>
          </div>
        </div>
